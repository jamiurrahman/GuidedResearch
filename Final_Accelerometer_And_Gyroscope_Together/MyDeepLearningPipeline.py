...
class MyDeepLearningPipeline:
    ...
    def runTraining(self):
        ...
        test_predict_delta_s_and_alpha_in_x_y_and_z = Configuration.model.predict(self.test_dataset)
        
        self.dataset_creator.test_delta_t = self.dataset_creator.denormalize(self.dataset_creator.test_delta_t)
        self.dataset_creator.test_delta_s_and_alpha_in_x_y_and_z = self.dataset_creator.denormalize(self.dataset_creator.test_delta_s_and_alpha_in_x_y_and_z)
        test_predict_delta_s_and_alpha_in_x_y_and_z = self.dataset_creator.denormalize(test_predict_delta_s_and_alpha_in_x_y_and_z)
        ...
        mae = sum(abs(self.dataset_creator.test_delta_s_and_alpha_in_x_y_and_z - test_predict_delta_s_and_alpha_in_x_y_and_z)) / len(test_predict_delta_s_and_alpha_in_x_y_and_z)
