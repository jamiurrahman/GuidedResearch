...
class Dataset_Creator:
    ...
    def create_dataset_for_all_sensors(self, df):
        # ***********************************************************************************************************
        # Creating Dataset with acceleration
        # Start
        ...
        delta_s_x = (np.diff(original_position_x_t, axis=0))
        delta_s_y = (np.diff(original_position_y_t, axis=0))
        delta_s_z = (np.diff(original_position_z_t, axis=0))

        ## delta_s = ((delta_s_x ** 2) + (delta_s_y ** 2) + (delta_s_z ** 2)) ** 0.5  # calculating total displacement

        print("delta_s_x", delta_s_x[0:5])
        print("delta_s_y", delta_s_y[0:5])
        print("delta_s_z", delta_s_z[0:5])
        # print(delta_s[0:5])
        ...
        delta_s_x = np.expand_dims(delta_s_x, axis=1)  # Expanding one axis to column
        delta_s_y = np.expand_dims(delta_s_y, axis=1)  # Expanding one axis to column
        delta_s_z = np.expand_dims(delta_s_z, axis=1)  # Expanding one axis to column
        ...
        normalized_acc_1_x = self.normalize(original_acc_1_x, TRAIN_SIZE=self.TRAIN_SIZE)
        normalized_acc_2_x = self.normalize(original_acc_2_x, TRAIN_SIZE=self.TRAIN_SIZE)
        normalized_acc_3_x = self.normalize(original_acc_3_x, TRAIN_SIZE=self.TRAIN_SIZE)
        normalized_acc_4_x = self.normalize(original_acc_4_x, TRAIN_SIZE=self.TRAIN_SIZE)
        normalized_acc_5_x = self.normalize(original_acc_5_x, TRAIN_SIZE=self.TRAIN_SIZE)
        normalized_acc_6_x = self.normalize(original_acc_6_x, TRAIN_SIZE=self.TRAIN_SIZE)
        normalized_acc_7_x = self.normalize(original_acc_7_x, TRAIN_SIZE=self.TRAIN_SIZE)
        normalized_acc_8_x = self.normalize(original_acc_8_x, TRAIN_SIZE=self.TRAIN_SIZE)

        normalized_acc_1_y = self.normalize(original_acc_1_y, TRAIN_SIZE=self.TRAIN_SIZE)
        normalized_acc_2_y = self.normalize(original_acc_2_y, TRAIN_SIZE=self.TRAIN_SIZE)
        normalized_acc_3_y = self.normalize(original_acc_3_y, TRAIN_SIZE=self.TRAIN_SIZE)
        normalized_acc_4_y = self.normalize(original_acc_4_y, TRAIN_SIZE=self.TRAIN_SIZE)
        normalized_acc_5_y = self.normalize(original_acc_5_y, TRAIN_SIZE=self.TRAIN_SIZE)
        normalized_acc_6_y = self.normalize(original_acc_6_y, TRAIN_SIZE=self.TRAIN_SIZE)
        normalized_acc_7_y = self.normalize(original_acc_7_y, TRAIN_SIZE=self.TRAIN_SIZE)
        normalized_acc_8_y = self.normalize(original_acc_8_y, TRAIN_SIZE=self.TRAIN_SIZE)

        normalized_acc_1_z = self.normalize(original_acc_1_z, TRAIN_SIZE=self.TRAIN_SIZE)
        normalized_acc_2_z = self.normalize(original_acc_2_z, TRAIN_SIZE=self.TRAIN_SIZE)
        normalized_acc_3_z = self.normalize(original_acc_3_z, TRAIN_SIZE=self.TRAIN_SIZE)
        normalized_acc_4_z = self.normalize(original_acc_4_z, TRAIN_SIZE=self.TRAIN_SIZE)
        normalized_acc_5_z = self.normalize(original_acc_5_z, TRAIN_SIZE=self.TRAIN_SIZE)
        normalized_acc_6_z = self.normalize(original_acc_6_z, TRAIN_SIZE=self.TRAIN_SIZE)
        normalized_acc_7_z = self.normalize(original_acc_7_z, TRAIN_SIZE=self.TRAIN_SIZE)
        normalized_acc_8_z = self.normalize(original_acc_8_z, TRAIN_SIZE=self.TRAIN_SIZE)
        ...
        train_acc_1_x, val_acc_1_x, test_acc_1_x = split(normalized_acc_1_x, TRAIN_SIZE=self.TRAIN_SIZE,
                                                         VALIDATION_SIZE=VALIDATION_SIZE, TEST_SIZE=TEST_SIZE)
        train_acc_2_x, val_acc_2_x, test_acc_2_x = split(normalized_acc_2_x, TRAIN_SIZE=self.TRAIN_SIZE,
                                                         VALIDATION_SIZE=VALIDATION_SIZE, TEST_SIZE=TEST_SIZE)
        train_acc_3_x, val_acc_3_x, test_acc_3_x = split(normalized_acc_3_x, TRAIN_SIZE=self.TRAIN_SIZE,
                                                         VALIDATION_SIZE=VALIDATION_SIZE, TEST_SIZE=TEST_SIZE)
        train_acc_4_x, val_acc_4_x, test_acc_4_x = split(normalized_acc_4_x, TRAIN_SIZE=self.TRAIN_SIZE,
                                                         VALIDATION_SIZE=VALIDATION_SIZE, TEST_SIZE=TEST_SIZE)
        train_acc_5_x, val_acc_5_x, test_acc_5_x = split(normalized_acc_5_x, TRAIN_SIZE=self.TRAIN_SIZE,
                                                         VALIDATION_SIZE=VALIDATION_SIZE, TEST_SIZE=TEST_SIZE)
        train_acc_6_x, val_acc_6_x, test_acc_6_x = split(normalized_acc_6_x, TRAIN_SIZE=self.TRAIN_SIZE,
                                                         VALIDATION_SIZE=VALIDATION_SIZE, TEST_SIZE=TEST_SIZE)
        train_acc_7_x, val_acc_7_x, test_acc_7_x = split(normalized_acc_7_x, TRAIN_SIZE=self.TRAIN_SIZE,
                                                         VALIDATION_SIZE=VALIDATION_SIZE, TEST_SIZE=TEST_SIZE)
        train_acc_8_x, val_acc_8_x, test_acc_8_x = split(normalized_acc_8_x, TRAIN_SIZE=self.TRAIN_SIZE,
                                                         VALIDATION_SIZE=VALIDATION_SIZE, TEST_SIZE=TEST_SIZE)
        train_delta_t, val_delta_t, test_delta_t = split(normalized_delta_t, TRAIN_SIZE=self.TRAIN_SIZE,
                                                         VALIDATION_SIZE=VALIDATION_SIZE, TEST_SIZE=TEST_SIZE)

        train_acc_1_y, val_acc_1_y, test_acc_1_y = split(normalized_acc_1_y, TRAIN_SIZE=self.TRAIN_SIZE,
                                                         VALIDATION_SIZE=VALIDATION_SIZE, TEST_SIZE=TEST_SIZE)
        train_acc_2_y, val_acc_2_y, test_acc_2_y = split(normalized_acc_2_y, TRAIN_SIZE=self.TRAIN_SIZE,
                                                         VALIDATION_SIZE=VALIDATION_SIZE, TEST_SIZE=TEST_SIZE)
        train_acc_3_y, val_acc_3_y, test_acc_3_y = split(normalized_acc_3_y, TRAIN_SIZE=self.TRAIN_SIZE,
                                                         VALIDATION_SIZE=VALIDATION_SIZE, TEST_SIZE=TEST_SIZE)
        train_acc_4_y, val_acc_4_y, test_acc_4_y = split(normalized_acc_4_y, TRAIN_SIZE=self.TRAIN_SIZE,
                                                         VALIDATION_SIZE=VALIDATION_SIZE, TEST_SIZE=TEST_SIZE)
        train_acc_5_y, val_acc_5_y, test_acc_5_y = split(normalized_acc_5_y, TRAIN_SIZE=self.TRAIN_SIZE,
                                                         VALIDATION_SIZE=VALIDATION_SIZE, TEST_SIZE=TEST_SIZE)
        train_acc_6_y, val_acc_6_y, test_acc_6_y = split(normalized_acc_6_y, TRAIN_SIZE=self.TRAIN_SIZE,
                                                         VALIDATION_SIZE=VALIDATION_SIZE, TEST_SIZE=TEST_SIZE)
        train_acc_7_y, val_acc_7_y, test_acc_7_y = split(normalized_acc_7_y, TRAIN_SIZE=self.TRAIN_SIZE,
                                                         VALIDATION_SIZE=VALIDATION_SIZE, TEST_SIZE=TEST_SIZE)
        train_acc_8_y, val_acc_8_y, test_acc_8_y = split(normalized_acc_8_y, TRAIN_SIZE=self.TRAIN_SIZE,
                                                         VALIDATION_SIZE=VALIDATION_SIZE, TEST_SIZE=TEST_SIZE)
        train_delta_t, val_delta_t, test_delta_t = split(normalized_delta_t, TRAIN_SIZE=self.TRAIN_SIZE,
                                                         VALIDATION_SIZE=VALIDATION_SIZE, TEST_SIZE=TEST_SIZE)

        train_acc_1_z, val_acc_1_z, test_acc_1_z = split(normalized_acc_1_z, TRAIN_SIZE=self.TRAIN_SIZE,
                                                         VALIDATION_SIZE=VALIDATION_SIZE, TEST_SIZE=TEST_SIZE)
        train_acc_2_z, val_acc_2_z, test_acc_2_z = split(normalized_acc_2_z, TRAIN_SIZE=self.TRAIN_SIZE,
                                                         VALIDATION_SIZE=VALIDATION_SIZE, TEST_SIZE=TEST_SIZE)
        train_acc_3_z, val_acc_3_z, test_acc_3_z = split(normalized_acc_3_z, TRAIN_SIZE=self.TRAIN_SIZE,
                                                         VALIDATION_SIZE=VALIDATION_SIZE, TEST_SIZE=TEST_SIZE)
        train_acc_4_z, val_acc_4_z, test_acc_4_z = split(normalized_acc_4_z, TRAIN_SIZE=self.TRAIN_SIZE,
                                                         VALIDATION_SIZE=VALIDATION_SIZE, TEST_SIZE=TEST_SIZE)
        train_acc_5_z, val_acc_5_z, test_acc_5_z = split(normalized_acc_5_z, TRAIN_SIZE=self.TRAIN_SIZE,
                                                         VALIDATION_SIZE=VALIDATION_SIZE, TEST_SIZE=TEST_SIZE)
        train_acc_6_z, val_acc_6_z, test_acc_6_z = split(normalized_acc_6_z, TRAIN_SIZE=self.TRAIN_SIZE,
                                                         VALIDATION_SIZE=VALIDATION_SIZE, TEST_SIZE=TEST_SIZE)
        train_acc_7_z, val_acc_7_z, test_acc_7_z = split(normalized_acc_7_z, TRAIN_SIZE=self.TRAIN_SIZE,
                                                         VALIDATION_SIZE=VALIDATION_SIZE, TEST_SIZE=TEST_SIZE)
        train_acc_8_z, val_acc_8_z, test_acc_8_z = split(normalized_acc_8_z, TRAIN_SIZE=self.TRAIN_SIZE,
                                                         VALIDATION_SIZE=VALIDATION_SIZE, TEST_SIZE=TEST_SIZE)
        train_delta_t, val_delta_t, self.test_delta_t = split(normalized_delta_t, TRAIN_SIZE=self.TRAIN_SIZE,
                                                              VALIDATION_SIZE=VALIDATION_SIZE, TEST_SIZE=TEST_SIZE)

        train_delta_s_x, val_delta_s_x, self.test_delta_s_x = split(delta_s_x, TRAIN_SIZE=self.TRAIN_SIZE,
                                                                    VALIDATION_SIZE=VALIDATION_SIZE,
                                                                    TEST_SIZE=TEST_SIZE)
        train_delta_s_y, val_delta_s_y, self.test_delta_s_y = split(delta_s_y, TRAIN_SIZE=self.TRAIN_SIZE,
                                                                    VALIDATION_SIZE=VALIDATION_SIZE,
                                                                    TEST_SIZE=TEST_SIZE)
        train_delta_s_z, val_delta_s_z, self.test_delta_s_z = split(delta_s_z, TRAIN_SIZE=self.TRAIN_SIZE,
                                                                    VALIDATION_SIZE=VALIDATION_SIZE,
                                                                    TEST_SIZE=TEST_SIZE)

        '''
        train_features = np.concatenate((train_acc_1_x, train_acc_2_x, train_acc_3_x, train_acc_4_x, train_acc_5_x,
                                         train_acc_6_x, train_acc_7_x, train_acc_8_x,
                                         train_acc_1_y, train_acc_2_y, train_acc_3_y, train_acc_4_y, train_acc_5_y,
                                         train_acc_6_y, train_acc_7_y, train_acc_8_y,
                                         train_acc_1_z, train_acc_2_z, train_acc_3_z, train_acc_4_z, train_acc_5_z,
                                         train_acc_6_z, train_acc_7_z, train_acc_8_z,
                                         train_delta_t), axis=1)
        val_features = np.concatenate(
            (val_acc_1_x, val_acc_2_x, val_acc_3_x, val_acc_4_x, val_acc_5_x, val_acc_6_x, val_acc_7_x, val_acc_8_x,
             ...
             val_delta_t), axis=1)
        test_features = np.concatenate((test_acc_1_x, test_acc_2_x, test_acc_3_x, test_acc_4_x, test_acc_5_x,
                                        test_acc_6_x, test_acc_7_x, test_acc_8_x,
                                        test_acc_1_y, test_acc_2_y, test_acc_3_y, test_acc_4_y, test_acc_5_y,
                                        test_acc_6_y, test_acc_7_y, test_acc_8_y,
                                        test_acc_1_z, test_acc_2_z, test_acc_3_z, test_acc_4_z, test_acc_5_z,
                                        test_acc_6_z, test_acc_7_z, test_acc_8_z,
        ...
        #     (train_features, train_delta_s_x))
        # self.val_dataset = tf.data.Dataset.from_tensor_slices(
        #     (val_features, val_delta_s_x))
        # self.test_dataset = tf.data.Dataset.from_tensor_slices(
        #     (test_features, test_delta_s_x))

        '''

        train_delta_s_x_y_and_z = np.concatenate((train_delta_s_x, train_delta_s_y, train_delta_s_z), axis=1)
        val_delta_s_x_y_and_z = np.concatenate((val_delta_s_x, val_delta_s_y, val_delta_s_z), axis=1)
        self.test_delta_s_x_y_and_z = np.concatenate((self.test_delta_s_x, self.test_delta_s_y, self.test_delta_s_z),
                                                     axis=1)

        train_dataset_features = tf.data.Dataset.from_tensor_slices(train_features)
        train_dataset_labels = tf.data.Dataset.from_tensor_slices(train_delta_s_x_y_and_z)

        val_dataset_features = tf.data.Dataset.from_tensor_slices(val_features)
        val_dataset_labels = tf.data.Dataset.from_tensor_slices(val_delta_s_x_y_and_z)

        test_dataset_features = tf.data.Dataset.from_tensor_slices(test_features)
        test_dataset_labels = tf.data.Dataset.from_tensor_slices(self.test_delta_s_x_y_and_z)
        ...
        print("delta_alpha_x : ", delta_alpha_x[0:5])
        print("delta_alpha_y : ", delta_alpha_y[0:5])
        print("delta_alpha_z : ", delta_alpha_z[0:5])
        ...
        # TRAIN_SIZE = int(len(delta_t) * 0.6)  # 5000
        # VALIDATION_SIZE = int(len(delta_t) * 0.20)  # 500
        # TEST_SIZE = int(len(delta_t) - (TRAIN_SIZE + VALIDATION_SIZE))
        ...
        train_delta_alpha_x, val_delta_alpha_x, self.test_delta_alpha_x = split(delta_alpha_x,
                                                                                TRAIN_SIZE=self.TRAIN_SIZE,
                                                                                VALIDATION_SIZE=VALIDATION_SIZE,
                                                                                TEST_SIZE=TEST_SIZE)
        train_delta_alpha_y, val_delta_alpha_y, self.test_delta_alpha_y = split(delta_alpha_y,
                                                                                TRAIN_SIZE=self.TRAIN_SIZE,
                                                                                VALIDATION_SIZE=VALIDATION_SIZE,
                                                                                TEST_SIZE=TEST_SIZE)
        train_delta_alpha_z, val_delta_alpha_z, self.test_delta_alpha_z = split(delta_alpha_z,
                                                                                TRAIN_SIZE=self.TRAIN_SIZE,
                                                                                VALIDATION_SIZE=VALIDATION_SIZE,
                                                                                TEST_SIZE=TEST_SIZE)

        train_features = np.concatenate((train_acc_1_x, train_acc_2_x, train_acc_3_x, train_acc_4_x,
                                         train_acc_5_x, train_acc_6_x, train_acc_7_x, train_acc_8_x,
                                         train_acc_1_y, train_acc_2_y, train_acc_3_y, train_acc_4_y,
                                         train_acc_5_y, train_acc_6_y, train_acc_7_y, train_acc_8_y,
                                         train_acc_1_z, train_acc_2_z, train_acc_3_z, train_acc_4_z,
                                         train_acc_5_z, train_acc_6_z, train_acc_7_z, train_acc_8_z,
                                         train_gyro_1_x, train_gyro_2_x, train_gyro_3_x, train_gyro_4_x,
                                         train_gyro_5_x, train_gyro_6_x, train_gyro_7_x, train_gyro_8_x,
                                         train_gyro_1_y, train_gyro_2_y, train_gyro_3_y, train_gyro_4_y,
                                         train_gyro_5_y, train_gyro_6_y, train_gyro_7_y, train_gyro_8_y,
                                         train_gyro_1_z, train_gyro_2_z, train_gyro_3_z, train_gyro_4_z,
                                         train_gyro_5_z, train_gyro_6_z, train_gyro_7_z, train_gyro_8_z,
                                         train_delta_t), axis=1)

        val_features = np.concatenate((val_acc_1_x, val_acc_2_x, val_acc_3_x, val_acc_4_x,
                                       val_acc_5_x, val_acc_6_x, val_acc_7_x, val_acc_8_x,
                                       val_acc_1_y, val_acc_2_y, val_acc_3_y, val_acc_4_y,
                                       val_acc_5_y, val_acc_6_y, val_acc_7_y, val_acc_8_y,
                                       val_acc_1_z, val_acc_2_z, val_acc_3_z, val_acc_4_z,
                                       val_acc_5_z, val_acc_6_z, val_acc_7_z, val_acc_8_z,
                                       val_gyro_1_x, val_gyro_2_x, val_gyro_3_x, val_gyro_4_x,
                                       val_gyro_5_x, val_gyro_6_x, val_gyro_7_x, val_gyro_8_x,
                                       val_gyro_1_y, val_gyro_2_y, val_gyro_3_y, val_gyro_4_y,
                                       val_gyro_5_y, val_gyro_6_y, val_gyro_7_y, val_gyro_8_y,
                                       val_gyro_1_z, val_gyro_2_z, val_gyro_3_z, val_gyro_4_z,
                                       val_gyro_5_z, val_gyro_6_z, val_gyro_7_z, val_gyro_8_z,
                                       val_delta_t), axis=1)

        test_features = np.concatenate((test_acc_1_x, test_acc_2_x, test_acc_3_x, test_acc_4_x,
                                        test_acc_5_x, test_acc_6_x, test_acc_7_x, test_acc_8_x,
                                        test_acc_1_y, test_acc_2_y, test_acc_3_y, test_acc_4_y,
                                        test_acc_5_y, test_acc_6_y, test_acc_7_y, test_acc_8_y,
                                        test_acc_1_z, test_acc_2_z, test_acc_3_z, test_acc_4_z,
                                        test_acc_5_z, test_acc_6_z, test_acc_7_z, test_acc_8_z,
                                        test_gyro_1_x, test_gyro_2_x, test_gyro_3_x, test_gyro_4_x,
                                        test_gyro_5_x, test_gyro_6_x, test_gyro_7_x, test_gyro_8_x,
                                        test_gyro_1_y, test_gyro_2_y, test_gyro_3_y, test_gyro_4_y,
                                        test_gyro_5_y, test_gyro_6_y, test_gyro_7_y, test_gyro_8_y,
                                        test_gyro_1_z, test_gyro_2_z, test_gyro_3_z, test_gyro_4_z,
                                        test_gyro_5_z, test_gyro_6_z, test_gyro_7_z, test_gyro_8_z,
                                        self.test_delta_t), axis=1)
        ...
        print("train_delta_s_x info : ", type(train_delta_s_x), np.shape(train_delta_s_x))
        print("train_delta_s_y info : ", type(train_delta_s_y), np.shape(train_delta_s_y))
        print("train_delta_s_z info : ", type(train_delta_s_z), np.shape(train_delta_s_z))
        ...
        print("val_delta_s_x info : ", type(val_delta_s_x), np.shape(val_delta_s_x))
        print("val_delta_s_y info : ", type(val_delta_s_y), np.shape(val_delta_s_y))
        print("val_delta_s_z info : ", type(val_delta_s_z), np.shape(val_delta_s_z))
        ...
        train_delta_alpha_x_y_and_z = np.concatenate((train_delta_alpha_x, train_delta_alpha_y, train_delta_alpha_z),
                                                     axis=1)
        val_delta_alpha_x_y_and_z = np.concatenate((val_delta_alpha_x, val_delta_alpha_y, val_delta_alpha_z), axis=1)
        self.test_delta_alpha_x_y_and_z = np.concatenate(
            (self.test_delta_alpha_x, self.test_delta_alpha_y, self.test_delta_alpha_z), axis=1)

        # New for together
        train_delta_s_and_alpha_in_x_y_and_z = np.concatenate((train_delta_s_x_y_and_z, train_delta_alpha_x_y_and_z),
                                                              axis=1)
        val_delta_s_and_alpha_in_x_y_and_z = np.concatenate((val_delta_s_x_y_and_z, val_delta_alpha_x_y_and_z), axis=1)
        self.test_delta_s_and_alpha_in_x_y_and_z = np.concatenate(
            (self.test_delta_s_x_y_and_z, self.test_delta_alpha_x_y_and_z), axis=1)

        train_dataset_features = tf.data.Dataset.from_tensor_slices(train_features)
        train_dataset_labels = tf.data.Dataset.from_tensor_slices(train_delta_s_and_alpha_in_x_y_and_z)

        val_dataset_features = tf.data.Dataset.from_tensor_slices(val_features)
        val_dataset_labels = tf.data.Dataset.from_tensor_slices(val_delta_s_and_alpha_in_x_y_and_z)

        test_dataset_features = tf.data.Dataset.from_tensor_slices(test_features)
        test_dataset_labels = tf.data.Dataset.from_tensor_slices(self.test_delta_s_and_alpha_in_x_y_and_z)
