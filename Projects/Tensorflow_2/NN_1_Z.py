...
delta_s = (np.diff(original_position_z_t, axis=0))
...
train_features = np.concatenate((train_acc_1_z, train_acc_2_z, train_acc_3_z, train_acc_4_z, train_acc_5_z, train_acc_6_z, train_acc_7_z, train_acc_8_z, train_delta_t), axis=1)
val_features = np.concatenate((val_acc_1_z, val_acc_2_z, val_acc_3_z, val_acc_4_z, val_acc_5_z, val_acc_6_z, val_acc_7_z, val_acc_8_z, val_delta_t), axis=1)
test_features = np.concatenate((test_acc_1_z, test_acc_2_z, test_acc_3_z, test_acc_4_z, test_acc_5_z, test_acc_6_z, test_acc_7_z, test_acc_8_z, test_delta_t), axis=1)
...
plt.plot(val_acc_1_z, val_delta_s.flatten(), "b.", linestyle="None", label="true")
plt.plot(val_acc_1_z, val_predict_delta_s.flatten(), "r.", linestyle="None", label="prediction")
plt.ylabel('Delta S')
...
plt.plot(test_acc_1_z, test_delta_s.flatten(), "b.", linestyle="None", label="true")
plt.plot(test_acc_1_z, test_predict_delta_s.flatten(), "r.", linestyle="None", label="prediction")
plt.ylabel('Delta S')
plt.xlabel('Acceleration')
plt.legend()
plt.title("Test Dataset Result")
