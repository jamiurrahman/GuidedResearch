...
train_features = np.concatenate((train_acc_1_x, train_acc_2_x, train_acc_3_x, train_acc_4_x, train_acc_5_x, train_acc_6_x, train_acc_7_x, train_acc_8_x, train_delta_t), axis=1)
val_features = np.concatenate((val_acc_1_x, val_acc_2_x, val_acc_3_x, val_acc_4_x, val_acc_5_x, val_acc_6_x, val_acc_7_x, val_acc_8_x, val_delta_t), axis=1)
test_features = np.concatenate((test_acc_1_x, test_acc_2_x, test_acc_3_x, test_acc_4_x, test_acc_5_x, test_acc_6_x, test_acc_7_x, test_acc_8_x, test_delta_t), axis=1)
