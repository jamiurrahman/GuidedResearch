...
delta_s = (np.diff(original_position_y_t, axis=0))

# print(original_acc1_x[0:5])
# print(original_position_y_t[0:5])
...
def plot(X, Y, Z, xlabel, ylabel, zlabel, color="b", marker="o"):
    limit = 6000
    #plt.plot(time_step[0:limit], original_position_y_t[0:limit], "g.-")
    #plt.show()
...
train_features = np.concatenate((train_acc_1_y, train_acc_2_y, train_acc_3_y, train_acc_4_y, train_acc_5_y, train_acc_6_y, train_acc_7_y, train_acc_8_y, train_delta_t), axis=1)
val_features = np.concatenate((val_acc_1_y, val_acc_2_y, val_acc_3_y, val_acc_4_y, val_acc_5_y, val_acc_6_y, val_acc_7_y, val_acc_8_y, val_delta_t), axis=1)
test_features = np.concatenate((test_acc_1_y, test_acc_2_y, test_acc_3_y, test_acc_4_y, test_acc_5_y, test_acc_6_y, test_acc_7_y, test_acc_8_y, test_delta_t), axis=1)
...
plt.plot(val_acc_1_y, val_delta_s.flatten(), "b.", linestyle="None", label="true")
plt.plot(val_acc_1_y, val_predict_delta_s.flatten(), "r.", linestyle="None", label="prediction")
plt.ylabel('Delta S')
...
plt.plot(test_acc_1_y, test_delta_s.flatten(), "b.", linestyle="None", label="true")
plt.plot(test_acc_1_y, test_predict_delta_s.flatten(), "r.", linestyle="None", label="prediction")
plt.ylabel('Delta S')
plt.xlabel('Acceleration')
plt.legend()
plt.title("Test Dataset Result")
