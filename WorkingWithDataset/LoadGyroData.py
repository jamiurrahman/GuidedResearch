...
label_train = "train-angular velocity"
label_test = "test-angular velocity"
label_prediction = "prediction"

label_x = "time"
label_y = "angular velocity"

gyro_4_x_data_features = np.array(gyro_4_data_features_calculated[:10000:10])
...
gyro_4_data_features_reshaped = np.reshape(gyro_4_x_data_features, (1000, 1))
...
targets = gyro_4_data_features_reshaped
