...
#
# time = np.loadtxt(cwd + '/Dataset/path_5/gyro_4.txt',comments='#', delimiter=' ', skiprows=1, usecols=range(0, 1))
...
#     pickle.dump([time, gyro_4_data_features, gyro_4_data_features, ground_truth_1_labels], f)
#
...
ground_truth_1_labels_position_temp = ground_truth_1_labels_loaded[:, 0:3]
ground_truth_1_labels_position_calculated = np.sqrt(np.sum(np.square(ground_truth_1_labels_position_temp), axis=1))

# Calculating orientation:
ground_truth_1_labels_orientation_temp = ground_truth_1_labels_loaded[:, 3:6]
ground_truth_1_labels_orientation_calculated = np.sqrt(np.sum(np.square(ground_truth_1_labels_orientation_temp), axis=1))

# print(ground_truth_1_labels_loaded[0:10])
# print(ground_truth_1_labels_position_calculated[0:5])
# print(ground_truth_1_labels_orientation_calculated[0:5])
...
label_train = "train-position"
label_test = "test-position"
label_prediction = "prediction"

label_x = "time"
label_y = "position"

ground_truth_1_labels_position_features = np.array(ground_truth_1_labels_position_calculated[:10000:10])
...
ground_truth_1_labels_position_features_reshaped = np.reshape(ground_truth_1_labels_position_features, (1000, 1))
...
targets = ground_truth_1_labels_position_features_reshaped
